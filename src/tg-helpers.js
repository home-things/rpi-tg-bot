module.exports = ({ app, config }) => ({
  ...
  sendMsgStderrChat: (msg) => (console.log(config.signals.sources.telegram.chats, config), app.telegram.sendMessage(config.signals.sources.telegram.chats.stderr, msg)),
})
